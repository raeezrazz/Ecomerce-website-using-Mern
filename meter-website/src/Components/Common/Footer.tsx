...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gradient-to-r from-blue-900 via-blue-850 to-blue-800 px-6 md:px-20 py-12">
      <div className="grid md:grid-cols-2 gap-10 items-start">
        ...
        <div>
          ...
          <h2 className="text-3xl font-semibold text-white">
            Ready to <span className="text-blue-300">Revamp</span> Your Vehicle Meters?
          </h2>
        ...
        <div className="flex flex-col gap-6 text-sm text-gray-800">
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-white font-small">Working Hours</p>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-white font-small">Location</p>
