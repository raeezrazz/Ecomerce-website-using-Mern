...
import { BindingScope, GetOptions, GetPlanOptions, OptionalGetOptions, PlanResult } from '@inversifyjs/core';
import { ServiceReferenceManager } from './ServiceReferenceManager';
export declare class ServiceResolutionManager {
    #private;
    constructor(serviceReferenceManager: ServiceReferenceManager, autobind: boolean, defaultScope: BindingScope);
