...
export function Header({ onMenuClick }: HeaderProps) {
  ...
  return (
    <header className="print:hidden sticky top-0 z-30 flex h-16 items-center gap-4 border-b border-border/80 bg-card/95 backdrop-blur supports-[backdrop-filter]:bg-card/80 px-4 lg:px-6 flex-shrink-0 shadow-sm">
      {/* Mobile menu button */}
      <Button
        variant="ghost"
        size="icon"
